...
class Extraccion:
    ...
    def extraer_api_staggin(self):
        ...
        for dato in resultado:
            with open('data/informacion.txt', 'a', encoding='utf-8') as archivo:
    ...
    def crear_tabla_apl1_contrato_digital(self):
        ...
        with engine.connect() as conn:
            conn.execute(text(consultas_sql.sql_crear_tabla_apl1_contrato_digital()))
            conn.commit()
                    ...
                    with conn.begin():
                        for fila in archivo:
                            ...
                            if(excepciones.excepciones_formato_mal_formado(fila)):
                                ...
                                conn.execute(text(consultas_sql.insert_apl1_contrato_digital()), {
